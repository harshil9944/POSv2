...
defined('CORE_APP_TITLE')   			OR define('CORE_APP_TITLE', 'V2 Stage');
defined('CORE_APP_URL')     			OR define('CORE_APP_URL', 'https://www.inntechfuture.com/');

defined('CORE_PRINT_NAME')  			OR define('CORE_PRINT_NAME', 'V2 Stage');
...
//Production Settings
defined('LIVE_BASE_URL')                OR  define('LIVE_BASE_URL', 'https://v2.inntechpos.com/');
defined('LIVE_GLOBAL_UPLOAD_PATH')      OR  define('LIVE_GLOBAL_UPLOAD_PATH', '/var/www/vhosts/v2.inntechpos.com/000-v2/uploads/');
...
defined('LIVE_DB_USERNAME')             OR  define('LIVE_DB_USERNAME', '000stage0722');
defined('LIVE_DB_PASSWORD')             OR  define('LIVE_DB_PASSWORD', 'Xh63i%71g');
defined('LIVE_DB_SCHEMA')               OR  define('LIVE_DB_SCHEMA', '000stage0722');
