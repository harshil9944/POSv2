...
! function(e) {
    ...
    function t(n) { if (a[n]) return a[n].exports; var o = a[n] = { i: n, l: !1, exports: {} }; return e[n].call(o.exports, o, o.exports, t), o.l = !0, o.exports }
    t.m = e, t.c = a, t.d = function(e, a, n) { t.o(e, a) || Object.defineProperty(e, a, { enumerable: !0, get: n }) }, t.r = function(e) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e, "__esModule", { value: !0 }) }, t.t = function(e, a) {
        if (1 & a && (e = t(e)), 8 & a) return e;
        if (4 & a && "object" == typeof e && e && e.__esModule) return e;
        var n = Object.create(null);
        if (t.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: e }), 2 & a && "string" != typeof e)
            for (var o in e) t.d(n, o, function(a) { return e[a] }.bind(null, o));
        return n
    ...
    var o = function() {
        ...
        var a, t, o;
        return a = e, o = [{ key: "updateTheme", value: function(e, a) { "default" === a ? e.length && e.remove() : e.length ? e.attr("href", a) : jQuery("#css-main").after('<link rel="stylesheet" id="css-theme" href="' + a + '">') } }, { key: "getWidth", value: function() { return window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth } }], (t = null) && n(a.prototype, t), o && n(a, o), e
    }();
    ...
    var r = function() {
        ...
        return a = e, n = [{
        ...
        }, { key: "coreBootstrapTabs", value: function() { jQuery('[data-toggle="tabs"]:not(.js-tabs-enabled)').add(".js-tabs:not(.js-tabs-enabled)").each(function(e, a) { jQuery(a).addClass("js-tabs-enabled").find("a").on("click.cb.helpers.core", function(e) { e.preventDefault(), jQuery(e.currentTarget).tab("show") }) }) } }, {
            ...
            value: function() {
                jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.cb.helpers.core", function(e) {
                    ...
                    t.addClass("js-scroll-to-enabled"), jQuery("html, body").animate({ scrollTop: jQuery(n).offset().top - l }, o)
                })
            }
        }, {
            key: "coreYearCopy",
            ...
            value: function() {
                jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each(function(e, a) {
                    ...
                    n.addClass("js-appear-enabled").appear(function() { setTimeout(function() { n.removeClass("invisible").addClass(l) }, i) }, { accY: r })
                })
            }
        }, {
            ...
            value: function() {
                jQuery('[data-toggle="countTo"]:not(.js-count-to-enabled)').each(function(e, a) {
                    var t = jQuery(a),
                        n = t.data("after"),
                        o = t.data("before");
                    t.addClass("js-count-to-enabled").appear(function() { t.countTo({ speed: t.data("speed") || 1500, refreshInterval: t.data("refresh-interval") || 15, onComplete: function() { n ? t.html(t.html() + n) : o && t.html(o + t.html()) } }) })
                })
            }
        }, {
            key: "coreRipple",
            value: function() {
                jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each(function(e, a) {
                    var t = jQuery(a);
                    t.addClass("js-click-ripple-enabled").css({ overflow: "hidden", position: "relative", "z-index": 1 }).on("click.cb.helpers.core", function(e) {
                        var a, n, o, l;
                        0 === t.children(".click-ripple").length ? t.prepend('<span class="click-ripple"></span>') : t.children(".click-ripple").removeClass("animate"), (a = t.children(".click-ripple")).height() || a.width() || (n = Math.max(t.outerWidth(), t.outerHeight()), a.css({ height: n, width: n })), o = e.pageX - t.offset().left - a.width() / 2, l = e.pageY - t.offset().top - a.height() / 2, a.css({ top: l + "px", left: o + "px" }).addClass("animate")
                    })
                })
            }
        }, {
        ...
        }, { key: "tableToolscheckRow", value: function(e, a) { a ? e.closest("tr").addClass("table-active") : e.closest("tr").removeClass("table-active") } }, {
            key: "contentFilter",
            value: function() {
                jQuery(".js-filter:not(.js-filter-enabled)").each(function(e, a) {
                    var t, n = jQuery(a),
                        ...
                        s = n.data("speed") || 200;
                    (n.addClass("js-filter-enabled"), l.length) && jQuery(window).on("resize.cb.helpers", function() { clearTimeout(t), t = setTimeout(function() { o.getWidth() < 768 ? l.addClass("flex-column") : l.removeClass("flex-column") }, 150) }).trigger("resize.cb.helpers");
                    n.data("numbers") && r.each(function(e, a) {
                        var t = jQuery(a),
                            n = t.data("category-link");
                        "all" === n ? t.append(" (" + i.length + ")") : t.append(" (" + i.filter('[data-category="' + n + '"]').length + ")")
                    }), r.on("click.cb.helpers", function(e) { var a, t = jQuery(e.currentTarget); return t.hasClass("active") || (r.removeClass("active"), t.addClass("active"), "all" === (a = t.data("category-link")) ? i.filter(":visible").length ? i.filter(":visible").fadeOut(s, function() { i.fadeIn(s) }) : i.fadeIn(s) : i.filter(":visible").length ? i.filter(":visible").fadeOut(s, function() { i.filter('[data-category="' + a + '"]').fadeIn(s) }) : i.filter('[data-category="' + a + '"]').fadeIn(s)), !1 })
                })
            }
        }, {
            key: "slimscroll",
            value: function() {
                jQuery('[data-toggle="slimscroll"]:not(.js-slimscroll-enabled)').each(function(e, a) {
                    var t = jQuery(a);
                    t.addClass("js-slimscroll-enabled").slimScroll({ height: t.data("height") || "200px", size: t.data("size") || "5px", position: t.data("position") || "right", color: t.data("color") || "#000", opacity: t.data("opacity") || ".25", distance: t.data("distance") || "0", alwaysVisible: !!t.data("always-visible"), railVisible: !!t.data("rail-visible"), railColor: t.data("rail-color") || "#999", railOpacity: t.data("rail-opacity") || .3 })
                })
            }
        }, { key: "magnific", value: function() { jQuery(".js-gallery:not(.js-gallery-enabled)").each(function(e, a) { jQuery(a).addClass("js-gallery-enabled").magnificPopup({ delegate: "a.img-lightbox", type: "image", gallery: { enabled: !0 } }) }) } }, {
            key: "summernote",
            value: function() {
        ...
        }, { key: "colorpicker", value: function() { jQuery(".js-colorpicker:not(.js-colorpicker-enabled)").each(function(e, a) { jQuery(a).addClass("js-colorpicker-enabled").colorpicker() }) } }, {
            key: "tagsInputs",
            value: function() {
                jQuery(".js-tags-input:not(.js-tags-input-enabled)").each(function(e, a) {
                    var t = jQuery(a);
                    t.addClass("js-tags-input-enabled").tagsInput({ height: t.data("height") || !1, width: t.data("width") || "100%", defaultText: t.data("default-text") || "Add tag", removeWithBackspace: t.data("remove-with-backspace") || !0, delimiter: [","] })
                })
            }
    ...
    var s = function() {
        ...
        return a = e, (t = [{ key: "_uiInit", value: function() { this._lHtml = jQuery("html"), this._lBody = jQuery("body"), this._lpageLoader = jQuery("#page-loader"), this._lPage = jQuery("#page-container"), this._lSidebar = jQuery("#sidebar"), this._lSideOverlay = jQuery("#side-overlay"), this._lHeader = jQuery("#page-header"), this._lHeaderSearch = jQuery("#page-header-search"), this._lHeaderSearchInput = jQuery("#page-header-search-input"), this._lHeaderLoader = jQuery("#page-header-loader"), this._lMain = jQuery("#main-container"), this._lFooter = jQuery("#page-footer"), this._lSidebarScroll = !1, this._lSideOverlayScroll = !1, this._windowW = o.getWidth(), this._uiHandleScroll("init"), this._uiHandleMain(), this._uiHandleHeader(), this._uiHandleNav(), this._uiHandleForms(), this._uiHandleTheme(), this._uiApiLayout(), this._uiApiBlocks(), this.helpers(["core-tooltip", "core-popover", "core-tab", "core-custom-file-input", "core-toggle-class", "core-scrollTo", "core-year-copy", "core-appear", "core-appear-countTo", "core-ripple"]), this._uiHandlePageLoader() } }, { key: "_uiHandleScroll", value: function() { this._lPage.hasClass("side-scroll") ? (this._lSidebar.length > 0 && !this._lSidebarScroll && (this._lSidebarScroll = new SimpleBar(this._lSidebar[0]), jQuery(".simplebar-scroll-content", this._lSidebar).scrollLock("enable")), this._lSideOverlay.length > 0 && !this._lSideOverlayScroll && (this._lSideOverlayScroll = new SimpleBar(this._lSideOverlay[0]), jQuery(".simplebar-scroll-content", this._lSideOverlay).scrollLock("enable"))) : (this._lSidebar && this._lSidebarScroll && (jQuery(".simplebar-scroll-content", this._lSidebar).scrollLock("disable"), this._lSidebarScroll.unMount(), this._lSidebarScroll = null, this._lSidebar.removeAttr("data-simplebar").html(jQuery(".simplebar-content", this._lSidebar).html())), this._lSideOverlay && this._lSideOverlayScroll && (jQuery(".simplebar-scroll-content", this._lSideOverlay).scrollLock("disable"), this._lSideOverlayScroll.unMount(), this._lSideOverlayScroll = null, this._lSideOverlay.removeAttr("data-simplebar").html(jQuery(".simplebar-content", this._lSideOverlay).html()))) } }, {
            ...
            value: function() {
                var e = this;
                jQuery(window).off("scroll.cb.header"), e._lPage.hasClass("page-header-glass") && e._lPage.hasClass("page-header-fixed") && jQuery(window).on("scroll.cb.header", function(a) { jQuery(a.currentTarget).scrollTop() > 60 ? e._lPage.addClass("page-header-scroll") : e._lPage.removeClass("page-header-scroll") }).trigger("scroll.cb.header")
            }
        }, {
            key: "_uiHandleNav",
            value: function() {
            ...
            value: function() {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').parent("li").addClass("active"), this._lPage.off("click.cb.themes"), this._lPage.on("click.cb.themes", '[data-toggle="theme"]', function(t) {
                    ...
                    var n = jQuery(t.currentTarget),
                        l = n.data("theme");
                    jQuery('[data-toggle="theme"]').parent("li").removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + l + '"]').parent("li").addClass("active"), o.updateTheme(e, l), e = jQuery("#css-theme"), a && Cookies.set("cbThemeName", l, { expires: 7 }), n.blur()
                })
            }
        }, {
            key: "_uiApiLayout",
            value: function() {
                ...
                var t = {
                    init: function() {
                        ...
                        }), a._lPage.hasClass("enable-page-overlay") && (a._lPage.prepend('<div id="page-overlay"></div>'), jQuery("#page-overlay").on("click.cb.overlay", function(e) { a._uiApiLayout("side_overlay_close") }))
                    },
                    ...
                    sidebar_style_inverse_toggle: function() { a._lPage.toggleClass("sidebar-inverse") },
                    sidebar_style_inverse_on: function() { a._lPage.addClass("sidebar-inverse") },
                    sidebar_style_inverse_off: function() { a._lPage.removeClass("sidebar-inverse") },
                    ...
                    side_overlay_open: function() { a._lPage.addClass("side-overlay-o"), jQuery(document).on("keydown.cb.sideOverlay", function(e) { 27 === e.which && (e.preventDefault(), a._uiApiLayout("side_overlay_close")) }) },
                    side_overlay_close: function() { a._lPage.removeClass("side-overlay-o"), jQuery(document).off("keydown.cb.sideOverlay") },
                    side_overlay_hoverable_toggle: function() { a._lPage.toggleClass("side-overlay-hover") },
                    side_overlay_hoverable_on: function() { a._lPage.addClass("side-overlay-hover") },
                    side_overlay_hoverable_off: function() { a._lPage.removeClass("side-overlay-hover") },
                    header_fixed_toggle: function() { a._lPage.toggleClass("page-header-fixed"), a._uiHandleHeader(), a._uiHandleMain() },
                    header_fixed_on: function() { a._lPage.addClass("page-header-fixed"), a._uiHandleHeader(), a._uiHandleMain() },
                    header_fixed_off: function() { a._lPage.removeClass("page-header-fixed"), a._uiHandleHeader(), a._uiHandleMain() },
                    header_style_modern: function() { a._lPage.removeClass("page-header-glass page-header-inverse").addClass("page-header-modern"), a._uiHandleHeader(), a._uiHandleMain() },
                    header_style_classic: function() { a._lPage.removeClass("page-header-glass page-header-modern"), a._uiHandleHeader(), a._uiHandleMain() },
                    header_style_glass: function() { a._lPage.removeClass("page-header-modern").addClass("page-header-glass"), a._uiHandleHeader(), a._uiHandleMain() },
                    header_style_inverse_toggle: function() { a._lPage.hasClass("page-header-modern") || a._lPage.toggleClass("page-header-inverse") },
                    header_style_inverse_on: function() { a._lPage.hasClass("page-header-modern") || a._lPage.addClass("page-header-inverse") },
                    header_style_inverse_off: function() { a._lPage.hasClass("page-header-modern") || a._lPage.removeClass("page-header-inverse") },
                    header_search_on: function() { a._lHeaderSearch.addClass("show"), a._lHeaderSearchInput.focus(), jQuery(document).on("keydown.cb.header.search", function(e) { 27 === e.which && (e.preventDefault(), a._uiApiLayout("header_search_off")) }) },
                    header_search_off: function() { a._lHeaderSearch.removeClass("show"), a._lHeaderSearchInput.blur(), jQuery(document).off("keydown.cb.header.search") },
                    header_loader_on: function() { a._lHeaderLoader.addClass("show") },
                    header_loader_off: function() { a._lHeaderLoader.removeClass("show") },
                    side_scroll_toggle: function() { a._lPage.toggleClass("side-scroll"), a._uiHandleScroll() },
                    side_scroll_on: function() { a._lPage.addClass("side-scroll"), a._uiHandleScroll() },
                    side_scroll_off: function() { a._lPage.removeClass("side-scroll"), a._uiHandleScroll() },
                ...
                var e, a, t, n = this,
                    ...
                    s = {
                        init: function() {
                            ...
                            }), r._lPage.off("click.cb.blocks"), r._lPage.on("click.cb.blocks", '[data-toggle="block-option"]', function(e) { n._uiApiBlocks(jQuery(e.currentTarget).closest(".block"), jQuery(e.currentTarget).data("action")) })
                        },
                        fullscreen_toggle: function() { e.removeClass("block-mode-pinned").toggleClass("block-mode-fullscreen"), e.hasClass("block-mode-fullscreen") ? jQuery(e).scrollLock("enable") : jQuery(e).scrollLock("disable"), a.length && (e.hasClass("block-mode-fullscreen") ? jQuery("i", a).removeClass(i).addClass("si si-size-actual") : jQuery("i", a).removeClass("si si-size-actual").addClass(i)) },
                        fullscreen_on: function() { e.removeClass("block-mode-pinned").addClass("block-mode-fullscreen"), jQuery(e).scrollLock("enable"), a.length && jQuery("i", a).removeClass(i).addClass("si si-size-actual") },
                        fullscreen_off: function() { e.removeClass("block-mode-fullscreen"), jQuery(e).scrollLock("disable"), a.length && jQuery("i", a).removeClass("si si-size-actual").addClass(i) },
                        content_toggle: function() { e.toggleClass("block-mode-hidden"), t.length && (e.hasClass("block-mode-hidden") ? jQuery("i", t).removeClass("si si-arrow-up").addClass("si si-arrow-down") : jQuery("i", t).removeClass("si si-arrow-down").addClass("si si-arrow-up")) },
                        content_hide: function() { e.addClass("block-mode-hidden"), t.length && jQuery("i", t).removeClass("si si-arrow-up").addClass("si si-arrow-down") },
                        content_show: function() { e.removeClass("block-mode-hidden"), t.length && jQuery("i", t).removeClass("si si-arrow-down").addClass("si si-arrow-up") },
        ...
        }, { key: "init", value: function() { this._uiInit() } }, { key: "layout", value: function(e) { this._uiApiLayout(e) } }, { key: "blocks", value: function(e, a) { this._uiApiBlocks(e, a) } }, { key: "loader", value: function(e, a) { this._uiHandlePageLoader(e, a) } }, {
            key: "helpers",
            value: function(e) {
    ...
    function d(e, a) { return !a || "object" !== c(a) && "function" != typeof a ? function(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e }(e) : a }
    ...
    function h(e, a) { return (h = Object.setPrototypeOf || function(e, a) { return e.__proto__ = a, e })(e, a) }
    t.d(a, "default", function() { return g });
    var g = function(e) {
        function a() { return function(e, a) { if (!(e instanceof a)) throw new TypeError("Cannot call a class as a function") }(this, a), d(this, u(a).call(this)) }
        return function(e, a) {
            if ("function" != typeof a && null !== a) throw new TypeError("Super expression must either be null or a function");
            e.prototype = Object.create(a && a.prototype, { constructor: { value: e, writable: !0, configurable: !0 } }), a && h(e, a)
        }(a, s), a
    }();
    jQuery(function() { window.Codebase = new g })
}]);