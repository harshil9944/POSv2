...
abstract class REST_Controller extends MX_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        /*_library('auth');
        $web_auth = $this->auth->validate_web_auth();*/
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        $use_key = ! (isset($this->methods[$controller_method]['Keys']) && $this->methods[$controller_method]['Keys'] === FALSE);
