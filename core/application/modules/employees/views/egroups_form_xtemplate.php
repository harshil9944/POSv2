<script type="text/x-template" id="egroup-form-template">
                            ...
                            <form id="frm-group" data-parsley-validate="true">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-20">
                                        <h5>Page Permissions <a href="#" @click.prevent="selectAllPermissions" class="font-14 ml-10">Select All</a>&nbsp;/&nbsp;<a href="#" @click.prevent="deselectAllPermissions" class="font-14">Deselect All</a></h5>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-20">
                                        <h5>Sub Permissions <a href="#" @click.prevent="selectAllSubPermissions" class="font-14 ml-10">Select All</a>&nbsp;/&nbsp;<a href="#" @click.prevent="deselectAllSubPermissions" class="font-14">Deselect All</a></h5>
                                    </div>
                                    <div class="col-sm-3" v-for="single in subPermissions">
                                        <div class="custom-control custom-checkbox mb-15">
                                            <input class="custom-control-input" v-model="group.subPermissions" :id="'sub-'+single.code" :value="single.code" type="checkbox">
                                            <label class="custom-control-label" :for="'sub-'+single.code">{{ single.code }}</label>
                                        </div>
                                    </div>
                                </div>
                                <hr>
