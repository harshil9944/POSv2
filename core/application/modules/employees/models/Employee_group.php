...
class Employee_group extends MY_Model
{
    public $allowed_groups = false;
    public function __construct() {
        parent::__construct();
        $this->table = EMPLOYEE_GROUP_TABLE;

        $this->allowed_groups = _get_setting('allowed_employee_groups',[]);
        if(!is_array($this->allowed_groups)) {
            $this->allowed_groups = [];
        }
    ...
    public function get_list($params=[]) {
        ...
        if($this->allowed_groups) {
            ...
            $this->where_in('id', $this->allowed_groups);
    ...
    public function get_list_count($params=[]) {
        ...
        if($this->allowed_groups) {
            ...
            $this->where_in('id', $allowed_groups);
