...
<div style="width:680px;">
    ...
    <table style="border-collapse: collapse; width: 100%; border-top: 1px solid <?php echo $table_border_color; ?>; border-left: 1px solid <?php echo $table_border_color; ?>; margin-bottom: 20px;">
        ...
        <tr>
            ...
            <td style="<?php echo $th_styles_right; ?>">Cash</td>
            <td style="<?php echo $th_styles_right; ?>">Card</td>
        ...
        <?php foreach($obj as $single){ ?>
            <tr>
                ...
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['openingCash']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['ordersCount']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['cashTransactionsTotal']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['cardTransactionsTotal']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['transactionsTotal']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['discountTotal']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['changeTotal']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo $single['tipTotal']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo ($single['status']==='Close')?$single['closingCash']:''; ?></td>
