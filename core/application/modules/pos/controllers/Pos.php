                                    ...
                                    if($item['type'] === 'single'){
                                        if($item['data']['prices']){
                                            $prices = array_values(array_filter($item['data']['prices'],function($single) use ($item_id,$sku_id,$unit_id){
                                                return $single['itemId'] === $item_id && $single['skuId'] === $sku_id && $single['unitId'] === $unit_id;
                                            }));
                                        ...
                                        if($item['data']['variations']){
                                            $prices = array_values(array_filter($item['data']['variations'],function($single) use ($item_id,$sku_id,$unit_id){
                                                return $single['itemId'] === $item_id && $single['skuId'] === $sku_id && $single['unitId'] === $unit_id;
                                            }));
                                            if($prices){
                                                foreach($prices as $price){
