...
class Warehouses extends MY_Controller {
    ...
    public $module = 'warehouses';
    public $model = 'warehouse';
    public $singular = 'Warehouse';
    public $plural = 'Warehouses';
    public $language = 'warehouses/warehouses';
    public $edit_form = '';
    public $form_xtemplate = 'warehouses_form_xtemplate';
    public function __construct()
    {
        parent::__construct();
        _model($this->model);
        $params = [
            'migration_path' => WAREHOUSE_MIGRATION_PATH,
            'migration_table' => WAREHOUSE_MIGRATION_TABLE
        ];
    ...
    protected function _load_files() {
        ...
        if(_get_method()=='add' || _get_method()=='edit') {
            ...
            $this->layout = 'warehouses_form_view';
