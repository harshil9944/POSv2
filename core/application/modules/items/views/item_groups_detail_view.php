                        ...
                        <table class="table table-bordered table-hover table-vcenter font-13">
                                <thead class="font-11">
                                    <tr class="bg-success-light">
                                        ...
                                        <th class="text-center">Veg / Non-Veg</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="(single ,index) in modal.obj.variations">
                                        ...
                                        <td class="text-center"><img class="img-fluid h-30p"  :src="getVegNVegImg(single.isVeg)" /> </td>
                                    </tr>
                                </tbody>
                        </table>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center" v-if="modal.obj.iconTitle">
                                        <i class="fa-3x" :class="modal.obj.iconTitle"></i>
                                    </td>
