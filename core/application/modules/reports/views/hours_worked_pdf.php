...
<div style="width:680px;">
    <div style="width:100%;color:#333;">
        <p style="margin:0;margin-bottom:5px;font-size:14px;text-align:right;text-transform: uppercase;"><strong>POS Hours Worked Report</strong></p>
    </div>
    <table style="border-collapse: collapse; width: 100%; border-top: 1px solid <?php echo $table_border_color; ?>; border-left: 1px solid <?php echo $table_border_color; ?>; margin-bottom: 20px;">
        ...
        <tr>
            ...
            <td style="<?php echo $th_styles_center; ?>">Shift Time</td>
        </tr>
        </thead>
        <tbody>
        <?php foreach($obj as $single){ ?>
            <tr>
                <td style="<?php echo $td_styles; ?>"><?php echo $single['name']; ?></td>
                <td style="<?php echo $td_styles_center; ?>"><?php echo $single['time']; ?></td>
            </tr>
        <?php } ?>
        </tbody>
    </table>
