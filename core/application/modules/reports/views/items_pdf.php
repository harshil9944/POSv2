...
<div style="width:680px;">
    <div style="width:100%;color:#333;">
        <p style="margin:0;margin-bottom:5px;font-size:14px;text-align:right;text-transform: uppercase;"><strong>Items Report</strong></p>
    </div>
    <table style="border-collapse: collapse; width: 100%; border-top: 1px solid <?php echo $table_border_color; ?>; border-left: 1px solid <?php echo $table_border_color; ?>; margin-bottom: 20px;">
        <thead>
        <tr>
            <td style="<?php echo $th_styles; ?>">Title</td>
            <td style="<?php echo $th_styles_right; ?>">Quantity</td>
        ...
        <?php foreach($obj as $single){ ?>
            <tr>
                <td style="<?php echo $td_styles_left; ?>"><?php echo $single['title']; ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo number_format($single['quantity']); ?></td>
                <td style="<?php echo $td_styles_right; ?>"><?php echo _get_setting('currency_sign',''), dsRound($single['total'],2); ?></td>
            </tr>
        <?php } ?>
        </tbody>
        <?php
        ...
        <tr>
            ...
            <td style="<?php echo $th_styles_right; ?>"><?php echo $total_quantity; ?></td>
            <td style="<?php echo $th_styles_right; ?>"><?php echo  _get_setting('currency_sign',''), $total_amount; ?></td>
        </tr>
        </tfoot>
    </table>
</div>
