<?php
defined('PROJECT_CODE')                 OR  define('PROJECT_CODE', 'bollywood');
defined('ENCRYPTION_KEY')               OR  define('ENCRYPTION_KEY', 'HbWqncMP7qs276lSLk3tywiJKvQiBtzW');

defined('CORE_APP_TITLE')   			OR define('CORE_APP_TITLE', 'Bollywood Indian Cuisine');
defined('CORE_APP_URL')     			OR define('CORE_APP_URL', 'https://www.inntechfuture.com/');

defined('CORE_PRINT_NAME')  			OR define('CORE_PRINT_NAME', 'Bollywood Indian Cuisine');
...
defined('DEV_BASE_URL')                 OR  define('DEV_BASE_URL', 'http://bollywood.v2.inntechpos.ci/');
...
defined('DEV_DB_SCHEMA')                OR  define('DEV_DB_SCHEMA', 'pos2_010_bollywood');

//Production Settings
defined('LIVE_BASE_URL')                OR  define('LIVE_BASE_URL', 'https://bollywood.v2.inntechpos.com/');
defined('LIVE_GLOBAL_UPLOAD_PATH')      OR  define('LIVE_GLOBAL_UPLOAD_PATH', '/var/www/vhosts/v2.inntechpos.com/010-bollywood/uploads/');
...
defined('LIVE_DB_USERNAME')             OR  define('LIVE_DB_USERNAME', '010bolly0523');
defined('LIVE_DB_PASSWORD')             OR  define('LIVE_DB_PASSWORD', '_5e15hh1E');
defined('LIVE_DB_SCHEMA')               OR  define('LIVE_DB_SCHEMA', '010bolly0523');
